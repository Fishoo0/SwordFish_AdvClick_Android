...
public class MainActivity extends AdvClickActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (SharedPrefAccountManager.getInstance().getCurrentUser().showYoumeng()) {
